...
export default function Main() {
  return (
    <section className="w-full bg-[#F2F0F1]">
      <div className="flex w-11/12 max-w-[1240px] justify-between items-center mx-auto max-md:flex-col max-lg:items-center max-xl:flex-col">
        <div className="flex flex-col w-full md:max-w-[630px] gap-8 py-24">
          ...
          <Link href="/shop" className="bg-black text-white w-fit px-16 py-2 rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95">
            Shop Now
          </Link>
        ...
        <div className="flex-1 lg:self-end md:w-1/2 mt-auto max-xl:w-1/4">
          <div className=" w-fit h-fit overflow-hidden ">
            <Image width={1200} src={bgMain} alt="" className='transition-transform duration-300 hover:scale-[1.03]'/>
          </div>
        </div>
      </div>
    </section>
