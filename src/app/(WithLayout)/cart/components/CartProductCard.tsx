...
export default function CartProductCard(
  ...
  return (
    <div className="flex h-[124px] gap-3 w-full">
      <Image className="w-auto h-full rounded-[9px]" src={process.env.BACKEND_HOST || "http://localhost:4200/api" + images[0]} width={300} height={300} alt="" />
      <div className="flex flex-col w-max">
        <h1 className="font-semibold max-sm:text-xs">{title}{id}</h1>
      ...
      <div className="flex flex-col justify-between ml-auto">
        ...
        <div className="h-[36px] flex items-center"><CountButton counter={counter} increase={increaseCounter} decrease={decreaseCounter}/></div>
      </div>
    </div>
  );
}
