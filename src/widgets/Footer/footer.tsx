  ...
  return (
    <footer className="w-full bg-[#F0F0F0] mt-[170px] relative pt-[140px] pb-10">
      <div className="max-w-[1240px] w-11/12 mx-auto absolute bg-black h-[180px] left-1/2 -translate-x-1/2 -top-[90px] rounded-2xl flex px-8 py-10 md:gap-20 gap-2 max-md:flex-col justify-between">
        <h1 className="xl:text-[40px] md:text-[30px] text-[20px] text-white text-wrap w-1/2 max-md:w-full">
        ...
        <div className="w-1/2 max-md:w-full">
          <form action="" className="max-md:flex items-center">
            <InputWithButton
              ...
              generalClassName="max-md:w-3/5"
            />
            <Button
              type="submit"
              variant="outline"
              className="bg-white rounded-3xl md:mt-5 w-full max-md:hidden transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95"
            >
            ...
            <Button
              type="submit"
              variant="outline"
              className="bg-white rounded-3xl md:mt-5 w-2/5 md:hidden transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95"
            >
              Subscribe
            </Button>
          </form>
      ...
      <div className="flex justify-between max-w-[1240px] w-11/12 mx-auto max-md:flex-wrap gap-y-8">
        <div className="max-sm:text-center max-sm:w-full">
          ...
          <p className="sm:w-[250px] text-gray-600">
